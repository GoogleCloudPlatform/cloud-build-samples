...
### New samples
 ...
 - The configuration file (e.g. `cloudbuild.yaml`) should be able to run as part of automated testing.  This means that in general, the file should contain substitutions rather than dummy values that the user has manually replace.  _Some exceptions to this rule may be allowed with sufficient justification_. 
